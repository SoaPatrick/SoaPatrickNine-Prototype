<article class="post post--list">
  ...
  <main>          
    <p>This is not a philosophical question but rather the title of my next project. Yes, I have an idea and a title already and it’s something I’m quite enthusiastic about. I will go into details of what this project is about in another blog entry, for now, I just have to announce it and put … <a href="../pages/box_single.php" class="more-link">more →</a></p>
  </main>    
  <footer>
    <div class="tags">
      <a href="../pages/box_tags__list.php" rel="tag">Filming</a>
      <a href="../pages/box_tags__list.php" rel="tag">Filming</a>
      <a href="../pages/box_tags__list.php" rel="tag">Filming</a>
    </div>              
  </footer>
