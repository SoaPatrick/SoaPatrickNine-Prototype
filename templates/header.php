...
<header class="site-header">
  <nav class="navigation">
    ...
    <a href="box_home.php" aria-label="Home" class="navigation__link">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path class="secondary" d="M32 160v288a32 32 0 0 0 32 32h384a32 32 0 0 0 32-32V160zm288 84a12 12 0 0 1-12 12H204a12 12 0 0 1-12-12v-8a12 12 0 0 1 12-12h104a12 12 0 0 1 12 12z"></path>
        <path class="primary" d="M512 64v48a16 16 0 0 1-16 16H16a16 16 0 0 1-16-16V64a32 32 0 0 1 32-32h448a32 32 0 0 1 32 32z"></path>
      </svg>          
      <span>Box</span>
    </a>
    ...
    <a href="factory_home.php" aria-label="Factory" class="navigation__link">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <a href="page_patrick.php" aria-label="Patrick" class="navigation__link">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    <a href="page_privacy.php" aria-label="Privacy" class="navigation__link">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
    ...
    <button type="button" id="toggle-search-collapse" aria-label="Search" class="navigation__link">
      <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
